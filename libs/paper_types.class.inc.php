...
class paper_types {
	...
	public static function addPaperType($db,$name,$cost,$width,$default = 0) {
		$error = 0;
		$message = "";
		if ($name == "") {
	...
	public static function setDefaultPaperType($db,$paperTypeId) {
		removeDefaultPaperType($db);
	...
	public static function updatePaperType($db,$paperTypeId,$name,$cost,$width,$default) {
	...
	//$paperTypeId - integer - paper type id
	//deletes paper type
	public static function deletePaperType($db,$paperTypeId) {
	...
	public static function getPaperType($db,$paperTypeId) {
	...
	public static function removeDefaultPaperType($db) {
