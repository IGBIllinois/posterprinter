...
class finish_option {
	...
	public static function addFinishOption($db,$name,$cost,$maxWidth,$maxLength,$default = 0) {
	...
	public static function updateFinishOption($db,$finishOptionId,$name,$cost,$maxWidth,$maxLength,$default) {
